...
EV/자동차 제조사를 포함한 자동차 회사들이 MaaS에 투자하는 본질은 **"차를 덜 팔고 이동 서비스를 파는"** 전환인데, 그 전환을 위해선 **"자가용 없이도 이 경로면 충분하다"** 는 정량 근거가 필요하다.
...
> - **"자가용보다 4분 더 걸리지만 3,418원 절약, 탄소 994g 감소"**
>
> 이 narrative가 자가용 대체 의사결정을 돕는 핵심입니다. EV/자동차 제조사가 ESG와 MaaS에 투자하는 이유와 정확히 맞닿아 있다고 봅니다."

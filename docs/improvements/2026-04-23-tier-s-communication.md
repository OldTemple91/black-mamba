...
오늘 10 커밋까지 와서 코드/문서는 충분히 두꺼워졌지만, **포트폴리오 통신력** 관점에서 치명적 구멍 3개가 남아있었다.
...
**"발표관이 README 스크롤 3초 안에 확신을 가지게 하는 요소"** 들이다. 코드 더 얹기보다 이게 우선.
...
>
> 이 세 가지가 **발표관이 README 를 3초 스크롤만 해도 확신을 가지게 만드는 요소** 입니다."

...
- **설계 포인트**: 확장 가능한 도메인 구조 + 허브 기반 탐색 + 신뢰도 기반 스코어링
...
- 프로젝트 설명: "실제 소유 킥보드를 가진 사용자의 출퇴근 멀티모달 경로 최적화"
...
## Phase 4 — 프로젝트 포지셔닝 정리 (우선순위: HIGH)
...
대중교통 + 따릉이 + 개인 이동수단의 최적 멀티모달 조합을 탐색하는 사이드 프로젝트.
```

### 4-2. 프로젝트 소개 문구 (README용)
